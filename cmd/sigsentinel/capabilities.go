...
func DefaultCapabilityRegistry() map[ControlIntent]CapabilitySpec {
	return map[ControlIntent]CapabilitySpec{
		...
		IntentMenuEnter:              {Command: "MNU", Safety: CapabilityDisruptive, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentMenuStatus:             {Command: "MSI", Safety: CapabilitySafe, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentMenuSetValue:           {Command: "MSV", Safety: CapabilityDisruptive, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentMenuBack:               {Command: "MSB", Safety: CapabilitySafe, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentAnalyzeStart:           {Command: "AST", Safety: CapabilityDisruptive, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentAnalyzePauseResume:     {Command: "APR", Safety: CapabilityDisruptive, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentPushWaterfall:          {Command: "PWF", Safety: CapabilityDisruptive, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentGetWaterfall:           {Command: "GWF", Safety: CapabilitySafe, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentSetDateTime:            {Command: "DTM", Safety: CapabilityDisruptive, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentGetDateTime:            {Command: "DTM", Safety: CapabilitySafe, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentSetLocationRange:       {Command: "LCR", Safety: CapabilityDisruptive, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentGetLocationRange:       {Command: "LCR", Safety: CapabilitySafe, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentGetDeviceInfo:          {Command: "MDL/VER", Safety: CapabilitySafe, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentGetModel:               {Command: "MDL", Safety: CapabilitySafe, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentGetFirmware:            {Command: "VER", Safety: CapabilitySafe, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentGetChargeStatus:        {Command: "GCS", Safety: CapabilitySafe, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentKeepAlive:              {Command: "KAL", Safety: CapabilitySafe, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
		IntentPowerOff:               {Command: "POF", Safety: CapabilityDestructive, DefaultEnabled: true, ExpertOnly: true, RequiresConnected: true},
	}
}
